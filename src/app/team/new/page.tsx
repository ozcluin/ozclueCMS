...
export default function NewTeamMemberPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (res.ok) {
      ...
      setError(typeof data.error === 'string' ? data.error : 'Failed to add team member');
    }
    setSaving(false);
  }
            ...
            <div className="form-card">
              <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-4)' }}>
                ...
                <div className="form-group">
                  ...
                  <input className="form-input" name="role" value={form.role} onChange={handleChange} required placeholder="e.g. Chief Executive Officer" />
                </div>
                <div className="form-group">
